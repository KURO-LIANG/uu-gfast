...
// GenTableColumnColumns defines and stores column names for table tools_gen_table_column.
...
// genTableColumnColumns holds the columns for table tools_gen_table_column.
