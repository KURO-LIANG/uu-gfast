...
func (s *toolsGenTableColumn) SelectDbTableColumnsByName(ctx context.Context, tableName string) ([]*entity.GenTableColumn, error) {
	db := g.DB()
	var res []*entity.GenTableColumn
...
func (s *toolsGenTableColumn) InitColumnField(ctx context.Context, column *entity.GenTableColumn, table *entity.GenTable) {
...
func (s *toolsGenTableColumn) SelectGenTableColumnListByTableId(ctx context.Context, tableId int64) (list []*entity.GenTableColumn, err error) {
...
func (s *toolsGenTableColumn) SetPkColumn(table *gen.ToolsGenTableExtend, columns []*entity.GenTableColumn) {
...
func (s *toolsGenTableColumn) GetAllTableColumns(ctx context.Context) (list []*entity.GenTableColumn, err error) {
	err = dao.GenTableColumn.Ctx(ctx).Order(dao.GenTableColumn.Columns().Sort + " asc, " + dao.GenTableColumn.Columns().ColumnId + " asc").Scan(&list)
	if err != nil {
		g.Log().Error(ctx, err)
